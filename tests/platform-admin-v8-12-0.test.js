...
test('service worker atual preserva multiempresa e painel consolidado',()=>{assert.match(sw,/multiempresa-v8-12-0\.js\?v=8225/);assert.match(sw,/platform-admin-v8-12-0\.js\?v=8225/);assert.match(sw,/john-erp-pwa-v8\.22\.5-persistent-media/)});
