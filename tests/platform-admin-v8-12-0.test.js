...
test('service worker atual preserva multiempresa e painel consolidado',()=>{assert.match(sw,/multiempresa-v8-12-0\.js\?v=\d+/);assert.match(sw,/platform-admin-v8-12-0\.js\?v=\d+/);assert.match(sw,/const CACHE='john-erp-pwa-v8\.22\.\d+[-\w]*'/);assert.match(sw,/transaction-persistence-v8-22-12\.js/)});
