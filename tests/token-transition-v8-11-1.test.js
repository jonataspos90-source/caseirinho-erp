...
test('service worker força cache atual e multiempresa 8.12',()=>{assert.match(sw,/const CACHE='john-erp-pwa-v8\.22\.\d+[-\w]*'/);assert.match(sw,/multiempresa-v8-12-0\.js\?v=\d+/);assert.match(sw,/transaction-persistence-v8-22-12\.js/)});
