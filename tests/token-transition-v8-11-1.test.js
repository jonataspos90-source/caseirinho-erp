...
test('service worker força cache atual e multiempresa 8.12',()=>{assert.match(sw,/john-erp-pwa-v8\.22\.2-central-only/);assert.match(sw,/multiempresa-v8-12-0\.js\?v=8222/)});
