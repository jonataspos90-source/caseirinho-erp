...
test('service worker força cache atual e multiempresa 8.12',()=>{assert.match(sw,/john-erp-pwa-v8\.22\.5-persistent-media/);assert.match(sw,/multiempresa-v8-12-0\.js\?v=8225/)});
