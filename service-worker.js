const CACHE='john-erp-pwa-v8.13.2-customer-experience';
...
const MULTI_TAG='<script src="./multiempresa-v8-12-0.js?v=8132"></'+'script>';
const STABILITY_TAG='<script src="./production-stability-v8-10-5.js?v=8132"></'+'script>';
const PLATFORM_TAG='<script src="./platform-admin-v8-12-0.js?v=8132"></'+'script>';
const EXPERIENCE_TAG='<script src="./ecommerce-customer-experience-v8-13-0.js?v=8132"></'+'script>';
