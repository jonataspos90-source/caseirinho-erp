const CACHE='john-erp-pwa-v8.22.9-store-settings';
...
const STORE_SETTINGS='./store-settings-sync-v8-22-9.js';
...
const MULTI_TAG='<script src="./multiempresa-v8-12-0.js?v=8229"></'+'script>';
const STABILITY_TAG='<script src="./production-stability-v8-10-5.js?v=8229"></'+'script>';
const PLATFORM_TAG='<script src="./platform-admin-v8-12-0.js?v=8229"></'+'script>';
const EXPERIENCE_TAG='<script src="./ecommerce-customer-experience-v8-13-0.js?v=8229"></'+'script>';
const HYDRATE_TAG='<script src="./server-catalog-hydration-v8-19.js?v=8229"></'+'script>';
const NEXTJS_TAG='<script src="./john-next-v8-17.js?v=8229"></'+'script>';
const NEXTCSS_TAG='<link rel="stylesheet" href="./john-next-v8-17.css?v=8229">';
const COMMERCE_TAG='<script src="./commerce-engine-v8-22-0.js?v=8229"></'+'script>';
const MANAGEMENT_TAG='<script src="./management-engine-v8-22-0.js?v=8229"></'+'script>';
const USAGE_TAG='<script src="./erp-usage-v8-20.js?v=8229"></'+'script>';
const SYNC_TAG='<script src="./caseirinho-commerce-sync-v8-21.js?v=8229"></'+'script>';
const STRICT_MEDIA_TAG='<script src="./strict-media-upload-v8-22-5.js?v=8229"></'+'script>';
const MEDIA_SYNC_TAG='<script src="./media-sync-fix-v8-22-6.js?v=8229"></'+'script>';
const PUBLISH_FIX_TAG='<script src="./catalog-publish-fix-v8-22-8.js?v=8229"></'+'script>';
const STORE_SETTINGS_TAG='<script src="./store-settings-sync-v8-22-9.js?v=8229"></'+'script>';
const RECOVERY_TAG='<script src="./ecommerce-recovery-v8-16-1.js?v=8229"></'+'script>';
const DEEP_TAG='<script src="./catalog-deep-recovery-v8-18-1.js?v=8229"></'+'script>';
const CENTRAL_FIX_TAG='<script src="./central-modules-hotfix-v8-22-2.js?v=8229"></'+'script>';
const USAGE_FIX_TAG='<script src="./erp-usage-v8-22-1.js?v=8229"></'+'script>';
const RELEASE_TAG='<script src="./release-consistency-v8-22-5.js?v=8229"></'+'script>';
...
async function injectScripts(response){
  ...
  html=injectBefore(html,'store-settings-sync-v8-22-9.js',STORE_SETTINGS_TAG);
