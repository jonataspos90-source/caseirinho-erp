...
function ensureMultiempresa(){
  ...
  s.src='./multiempresa-v8-12-0.js?v=8140';
  s.async=false;
...
function ensurePlatformOwner(){
  ...
  const s=document.createElement('script');
  s.src='./platform-admin-v8-12-0.js?v=8140';
  s.async=false;
...
function ensureCustomerExperience(){
  ...
  const s=document.createElement('script');
  s.src='./ecommerce-customer-experience-v8-13-0.js?v=8140';
  s.async=false;
...
console.info(
  '[John ERP] estabilidade preservada · Multiempresa/Plataforma V8.12.0 · Experiência V8.14.0'
);
})();